      ...
      <div className='mt-[3rem] flex sm:hidden' style={{ overflowX: "auto" }}>
        ...
        <div className='flex-row'>
          <div className='overview mt-[3rem]'>
            <h2 className='text-[#303030] text-xl m-3 font-bold'>Overview</h2>
            <hr />
            <div className='mt-[1.4rem]'>
              <p className='text-[14px] leading-[15.75px] text-[#3A3A3A] mx-[10px]'>{props.result.overview}</p>
          ...
          <div className='my-[2rem] px-3'>
            <h2 className='text-[#303030] text-xl font-semibold mb-[1.2rem]'>Qualifying Exams</h2>
            <div className="flex whitespace-nowrap" style={{ overflowX: "auto" }}>
              {props.result.exams?.map((exam, index) => {
                return <div id={index} className='hover:bg-[#303030] hover:text-[white] rounded-md mr-4 border-[1px] border-[rgba(233,233,233,1)] px-4 py-[.2rem] text-center text-[#2E2E2E] text-[14px]'>{exam}</div>
              })}
            </div>
          </div>
          {/* mode of admission  */}
          <div className='mt-[2rem] px-3'>
            <h2 className='text-[#303030] text-xl font-semibold mb-[1.2rem]'>Mode Of Admission</h2>
            <div className="flex whitespace-nowrap" style={{ overflowX: "auto" }}>
