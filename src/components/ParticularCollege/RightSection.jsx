  ...
  return (
    <div className='flex-row px-10'>
      <div className="newsFeeds mt-[3rem]">
        <h2 className=' text-[#303030] text-[18px] m-3 -ml-0 font-semibold'>News Feeds</h2>
        <hr />
        <div className='flex-row mt-[1.4rem] '>
          <div className='flex justify-between mb-8'>
            <img src={graduation} alt="" />
            <div className="content flex-col ml-3">
              <p className='font-bold text-[#363636] mb-2 text-[16px]'>JEE 2022 Result Declare, Download Your JEE 2022 Score Card</p>
              <span className='text-[#A7A7A7] tracking-wide'>Dec 19, 2022 9:30 AM</span>
            </div>
          </div>
          <div className='flex justify-between mb-8'>
            <img src={graduation} alt="" />
