    ...
    <div className="no-scrollbar flex md:max-w-[1150px] md:m-auto items-center overflow-x-auto gap-0 py-2">
      {skeleton ? (
        ...
        <>
          ...
          <Link to="/scheduler" className="h-[56px] w-[220px] mob:w-[160px] md:h-[158px] mx-1.5 flex justify-center items-center shadow-md rounded-md border border-gray-200 bg-white hover:bg-gradient-to-r from-white to-[#fff6ec] transition-all duration-500 font-medium cursor-pointer">
