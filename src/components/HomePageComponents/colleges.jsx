    ...
    <div className="mb-4 md:mb-8">
      ...
      <div className="no-scrollbar flex md:max-w-[1100px] md:m-auto items-center overflow-x-auto overflow-y-hidden gap-3 py-2">
        ...
        {collegeList.length >= 5 ? (
          <>
            <Link to="/allcolleges">
              <div className="min-w-[210px] flex-grow-1 md:min-w-[230px] h-[164px] md:h-[184px] flex justify-center items-center shadow-md rounded-md border bg-white hover:bg-gradient-to-r from-white to-[#fff6ec] transition-all duration-500 from-white to-[#fff6ec] font-medium cursor-pointer">
