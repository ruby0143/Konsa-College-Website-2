    ...
    <div className='mb-12'>
      ...
      <div className='mb-4'>
        ...
        <div className='mb-6 flex justify-center items-center'>
          <button className='flex items-center py-2 px-6 md:px-8 rounded-full text-sm md:text-base md:font-medium text-[#5a5a5a] hover:text-[#fcfcfc] bg-[#f4f4f4] hover:bg-[#EE7C00] shadow-md transition-all duration-300'>
